...
/**
 * Resposible for providing a Jdbc {@link javax.sql.DataSource} for
 * <p/>
 * The {@link javax.sql.DataSource} is a shared data source that should be used throughout
...
public interface DataSourceProvider {
     ...
     * the configuration will control the {@link javax.sql.DataSource} that will be
     * instansiated.
     *
     ...
     */
    void configure(String url, Settings settings) throws JDBCException;
