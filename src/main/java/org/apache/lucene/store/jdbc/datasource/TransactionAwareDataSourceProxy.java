 ...
 * <p/>
 * Wraps the created Jdbc <code>Connection</code> with a {@link org.apache.lucene.store.jdbc.datasource.ConnectionProxy}, which
 ...
 * <p/>
 * A set of simple utilities are provided in the {@link org.apache.lucene.store.jdbc.datasource.DataSourceUtils} for simpler management of
 * the <code>DataSource</code>, and special care is taken if the <code>DataSource</code> uses the
 * {@link org.apache.lucene.store.jdbc.datasource.ConnectionProxy} (such is the case with this data soruce). For example, the
 * {@link org.apache.lucene.store.jdbc.datasource.DataSourceUtils#commitConnectionIfPossible(java.sql.Connection)} and
 * {@link org.apache.lucene.store.jdbc.datasource.DataSourceUtils#rollbackConnectionIfPossible(java.sql.Connection)} will only call commit/rollback
 ...
 * {@link org.apache.lucene.store.jdbc.datasource.TransactionAwareDataSourceProxy} is there to help non managed transaction management.
 *
 * @author kimchy
...
public class TransactionAwareDataSourceProxy implements DataSource {
     ...
     * <p/>
     * Consider using {@link org.apache.lucene.store.jdbc.datasource.DataSourceUtils#getConnection(javax.sql.DataSource)} and
     * {@link org.apache.lucene.store.jdbc.datasource.DataSourceUtils#releaseConnection(java.sql.Connection)} for simpler usage.
     */
