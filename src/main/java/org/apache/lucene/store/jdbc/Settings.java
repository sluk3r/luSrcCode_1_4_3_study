...
public class Settings {
    ...
    private final Map<String, HashMap<String, Settings>> groups = new ConcurrentHashMap<String, HashMap<String, Settings>>();
    ...
    public Settings(ClassLoader classLoader) {
        this();
    ...
    public Map<String, Settings> getSettingGroups(String settingPrefix) {
        if (settingPrefix.charAt(settingPrefix.length() - 1) != '.') {
            settingPrefix = settingPrefix + ".";
        }
        Map<String, Settings> group = groups.get(settingPrefix);
        if (group != null) {
            return group;
        }
        // we don't really care that it might happen twice
        HashMap<String, Settings> map = new HashMap<String, Settings>();
        for (Object o : settings.keySet()) {
            ...
            if (setting.startsWith(settingPrefix)) {
                ...
                Settings groupSettings = map.get(name);
                if (groupSettings == null) {
                    groupSettings = new Settings();
    ...
    public Settings setSetting(String setting, String value) {
        if (value == null) {
            return this;
        }
    ...
    public Settings setObjectSetting(String setting, Object value) {
        if (value == null) {
            return this;
        }
        this.settings.put(setting, value);
    ...
    public Settings setBooleanSetting(String setting, boolean value) {
        setSetting(setting, String.valueOf(value));
        return this;
    }

    public Settings setFloatSetting(String setting, float value) {
        setSetting(setting, String.valueOf(value));
        return this;
    }

    public Settings setDoubleSetting(String setting, double value) {
        setSetting(setting, String.valueOf(value));
        return this;
    }

    public Settings setIntSetting(String setting, int value) {
        setSetting(setting, String.valueOf(value));
        return this;
    }

    public Settings setLongSetting(String setting, long value) {
        setSetting(setting, String.valueOf(value));
        return this;
    }

    public Settings setClassSetting(String setting, Class clazz) {
     ...
     */
    public Settings setGroupSettings(String settingPrefix, String groupName, String[] settings, Object[] values) {
