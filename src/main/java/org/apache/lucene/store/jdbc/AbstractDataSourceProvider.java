...
public abstract class AbstractDataSourceProvider implements DataSourceProvider {
    ...
    public void configure(String url, Settings settings) throws JDBCException {
    ...
    protected abstract DataSource doCreateDataSource(String url, Settings settings) throws JDBCException;
}
