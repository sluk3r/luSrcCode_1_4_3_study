...
public class ExternalDataSourceProvider extends AbstractDataSourceProvider {
    ...
    protected DataSource doCreateDataSource(String url, Settings settings) throws JDBCException {
        ...
        if (dataSource == null) {
            throw new JDBCException("Failed to find data source, have you set the static set data source?");
        } else {
